...
const ProfileCard = ({ userName, email, accountDetails }: Props) => {
  ...
  return (
    <section className='relative flex flex-col gap-12 items-start  rounded-3xl p-8 sm:p-14 shadow-xl shadow-black/30 border border-white/10 xl:w-[30%] h-fit bg-gradient-to-br from-[#11716e] to-[#032a3a]'>
